...
- [SaaS の導入サポート及び運用保守業務 ](#SaaSの導入サポート及び運用保守業務) -> (8 ヶ月)

## SES 企業 正社員として勤務(2021-12~2024-04)

客先常駐先でフロントエンドの開発を主に担当

- [DAM システムの開発](#DAMシステムの開発) -> (2 年)
...
- [大手キャリアの Web サイト運用更新案件](#大手キャリアのWebサイト運用更新案件)
...
<!-- この案件では、特に厳しい納期の中で迅速な開発が求められました。そのため、作業の効率化とタイムマネジメントが非常に重要であることを痛感しました。ディレクターとの綿密なコミュニケーションがプロジェクトの成功に欠かせず、要件の変更や新たな指示に迅速に対応することが求められました。また、技術的な課題に直面した際には、周りのエンジニアのサポートを求め、チーム一丸となって問題を解決しました。このような環境下で、他のメンバーとの協力を通じてプロジェクトを進行させることの重要性を再認識しました。 -->
